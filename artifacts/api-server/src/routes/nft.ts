...
router.get("/nft/metadata/:tokenId", async (req, res) => {
  ...
  const metadata = {
    ...
    description: "Autonomous AI treasury agent powered by SoSoValue market data, executing via SoDEX. Part of the TALOS Genesis Collection.",
    image: `https://talos-api-wfzx.onrender.com/api/nft/image/${tokenId}`,
    external_url: "https://talos-systems-talos-awwf.vercel.app",
    attributes: [
      { trait_type: "Network", value: "ValueChain" },
